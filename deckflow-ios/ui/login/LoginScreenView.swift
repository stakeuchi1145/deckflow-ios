            ...
            VStack {
                ...
                VStack {
                    ...
                    TextField("メールアドレスを入力してください。", text: $viewModel.userId)
                        ...
                        .padding()
                        .background(.white)
                        .border(focusedUserId ? Color(hex: "#FF2196F3") : Color(hex: "#FFDDDDDD"), width: focusedUserId ? 1.5 : 1)
                ...
                VStack {
                    ...
                    if self.viewModel.passHidden {
                        SecureField("パスワードを入力してください。", text: $viewModel.password)
                            ...
                            .padding()
                            .background(.white)
                            .border(focusedPassword ? Color(hex: "#FF2196F3") : Color(hex: "#FFDDDDDD"), width: focusedPassword ? 1.5 : 1)
                            .autocapitalization(.none)
                            .disableAutocorrection(true)
                ...
                Button(action: {
                    ...
                    Text("ログイン")
                        ...
                        .background(viewModel.isLogin ? Color(hex: "#FF2196F3") : Color(hex: "#FF808080"))
                        .cornerRadius(8)
                }
